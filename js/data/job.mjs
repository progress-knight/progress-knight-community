export default {
    ...
    "Footman":          {category: "Kingdom's Army", maxXp:      1000, income:    50,
    ...
    "Veteran footman":  {category: "Kingdom's Army", maxXp:     10000, income:   120,
    ...
    "Knight":           {category: "Kingdom's Army", maxXp:    100000, income:   300,
                         requirement: [{skill: "Strength", level: 100}, {job: "Veteran footman", level: 10}],
    ...
    "Veteran knight":   {category: "Kingdom's Army", maxXp:   1000000, income:  1000,
    ...
    "Elite knight":     {category: "Kingdom's Army", maxXp:   7500000, income:  3000,
                         requirement: [{skill: "Strength", level: 300}, {job: "Veteran knight", level: 10}],
    ...
    "Holy knight":      {category: "Kingdom's Army", maxXp:  40000000, income: 15000,
                         requirement: [{skill: "Mana control", level: 500}, {job: "Elite knight", level: 10}],
                         tooltip:"Collapse entire armies in mere seconds with your magically imbued blade. The handful of elite knights who attain this level of power are showered with coins."},
    "Legendary knight": {category: "Kingdom's Army", maxXp: 150000000, income: 50000,
                         requirement: [{skill: "Mana control", level: 1000}, {skill: "Battle tactics", level: 1000}, {job: "Holy knight", level: 10}],
                         tooltip:"Feared worldwide, obliterate entire nations in a blink of an eye. Roughly every century, only one holy knight is worthy of receiving such an esteemed title."},
