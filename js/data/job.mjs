export default {
    ...
    "Footman":          {category: "Kingdom's Army", maxXp:       500, income:     20,
                         requirement: [{skill: "Strength", level: 15}, {job: "Squire", level: 10}],
    ...
    "Veteran footman":  {category: "Kingdom's Army", maxXp:      2500, income:      50,
                         requirement: [{skill: "Battle tactics", level: 20}, {job: "Footman", level: 10}],
    ...
    "Horseman":         {category: "Kingdom's Army", maxXp:    12500, income:     120,
                         requirement: [{skill: "Strength", level: 30}, {job: "Veteran footman", level: 10}],
    ...
    "Knight":           {category: "Kingdom's Army", maxXp:    300000, income:    1000,
                         requirement: [{skill: "Strength", level: 100}, {job: "Veteran horseman", level: 10}],
